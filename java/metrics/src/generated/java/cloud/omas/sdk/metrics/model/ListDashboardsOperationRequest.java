...
public final class ListDashboardsOperationRequest {
    ...
    private ListDashboardsOperationRequest(Builder builder) {
    ...
    /**
     * Builds an immutable {@link ListDashboardsOperationRequest}.
     */
    ...
    public static final class Builder {
         ...
         * Sets maxResults.
         *
         * @param maxResults The maximum number of dashboards to return in a single response page.
         * @return this builder
         */
         ...
         * Sets nextToken.
         *
         * @param nextToken Pagination token to retrieve the next page of dashboards if the current result set is truncated.
         * @return this builder
         */
         ...
         */
        public ListDashboardsOperationRequest build() {
            return new ListDashboardsOperationRequest(this);
        }
    }
}
