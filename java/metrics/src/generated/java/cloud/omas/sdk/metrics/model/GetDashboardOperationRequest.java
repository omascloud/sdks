 ...
 */
@JsonDeserialize(builder = GetDashboardOperationRequest.Builder.class)
public final class GetDashboardOperationRequest {


    private final String dashboardId;

    private GetDashboardOperationRequest(Builder builder) {
    ...
    /**
     * Builds an immutable {@link GetDashboardOperationRequest}.
     */
    ...
    public static final class Builder {
         ...
         */
        public GetDashboardOperationRequest build() {
            return new GetDashboardOperationRequest(this);
        }
    }
}
